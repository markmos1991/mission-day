...
const Hero = () => {
  ...
  <div className="container flex flex-col items-center justify-center px-5 py-24 mx-auto">
    ...
    <div className="w-full text-center lg:w-2/3">
      ...
      <p className="mb-8 text-lg leading-relaxed">Information for the day including; Street art information, points of interest, and happy hours nearby. Teams will need to get a picture with each piece of art listed.</p>
